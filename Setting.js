...
global.github    = 'https://github.com/Silent042/SIGMA-MD' ;
...
global.owner = process.env.OWNER_NUMBER  || '2348168855791' ;  // ADD YOUR NUMBER WITHOUT +
...
global.mztit = process.env.MZTIT ||"Silent",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '08_03_2024_SIGMA_MD_6ez0mYG9_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'Silent-md',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `trenzalore`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'Silent',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "sigma" ,          // ADD YOUR STICKER PACKNAME
